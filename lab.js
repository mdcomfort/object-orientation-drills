...
favoriteThings['book'] = "Handmaid's Tale"
...
console.log(`The car is a ${color} ${make} ${model}, model year ${year}`)

let {color: MayaCarColor} = carDetails
console.log(MayaCarColor)

let {make: EricaCarMake} = carDetails
console.log(EricaCarMake)

let {model: companyCarModel} = carDetails
console.log(companyCarModel)

let {year: newModelYear} = carDetails
console.log(newModelYear)
